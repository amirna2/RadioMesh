...
public:
     ...
     * @returns RM_E_NONE if the WiFi access point was successfully started, an error code
     * otherwise.
     */
    virtual int start() = 0;
     ...
     * @returns RM_E_NONE if the WiFi access point was successfully stopped, an error code
     * otherwise.
     */
